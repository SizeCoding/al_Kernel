...
TriggerEvent('es:addGroupCommand', 'setgang', 'gangmaster', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = _U('setgang'), params = {{name = 'id', help = _U('id_param')}, {name = 'gang', help = _U('setgang_param2')}, {name = 'grade_id', help = _U('setgang_param3')}}})
...
TriggerEvent('es:addGroupCommand', 'revive', 'admin', function(source, args, user)
	if args[1] ~= nil then
		...
		TriggerClientEvent('esx_basicneeds:resetStatus', tonumber(args[1]))
	else
		TriggerClientEvent('ambulance:revive', source)
		TriggerClientEvent('esx_basicneeds:resetStatus', source)
	end
end, function(source, args, user)
...
TriggerEvent('es:addGroupCommand', 'die', 'admin', function(source, args, user)
	if args[1] ~= nil then
		TriggerClientEvent('es_admin:kill', tonumber(args[1]))
	else
