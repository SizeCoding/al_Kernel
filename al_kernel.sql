...
ALTER TABLE `users`
	...
	ADD COLUMN `job` VARCHAR(50) NULL DEFAULT 'chomeur' AFTER `skin`,
...
INSERT INTO `job_grades` VALUES (1,'chomeur',0,'chomeur','Chomeur',0,'{}','{}');
...
INSERT INTO `jobs` VALUES ('chomeur','Chomeur');
